  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-2 left-4 z-50 p-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-transform duration-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2"
      ...
      <AnimatePresence>
        <motion.aside
          ...
          className="fixed md:sticky top-0 left-0 h-screen w-56 sm:w-64 bg-gradient-to-b from-blue-900 to-purple-900 bg-opacity-80 backdrop-blur-lg shadow-2xl z-40 md:bg-opacity-100 md:backdrop-blur-none"
