...
export default function Quotations() {
  ...
  const enhancedHandleSubmitQuotation = async (e) => {
  ...
  useEffect(() => {
    const initializeUserData = async () => {
      try {
        ...
        // **FIXED**: Always set to 'all' for quotations to work with all shops
        setQuotationForm((prev) => ({ ...prev, shopId: 'all' }));
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-slate-600 font-medium">Create professional quotations</p>
            </div>
          </div>
          <button
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-blue-700">
                <strong>Note:</strong> This quotation system accesses products from all shops to ensure maximum flexibility.
              </p>
            </div>
          </div>
        </div>
